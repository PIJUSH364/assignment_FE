...
export const sliderData = [
    {
        ...
        description: " The talent market is at its competitive best right now. Hiring great talent is not just how you grow, but exist. The founding team of Kula has just the ingredients to solve the recruitment puzzle for companies at all stages of growth.",
    ...
    },
    {
        ...
        description: " Kula is building a solution that is desperately needed in today’s ultra-competitive talent market. The team combines a deep understanding of recruiting with the latest product and engineering standards - resulting in an intuitive and super-efficient solution that users love.",
        name: "Roel Janssen",
