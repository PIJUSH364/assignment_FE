        ...
        <div className='text-center md:p-24 p-10 pb-36 '>
            <div className='flex  lg:flex-row flex-col justify-center gap-14 pt-20 '>
                ...
                <div >
                    ...
                    <p className='text-one-zero-nine  text-lg leading-6 md:text-center text-justify'> Measure the talent pipeline, manage recruiting performance, and forecast predictably by having complete visibility over the metrics that matter for your recruitment process.</p>
                </div>
                <div>
                    ...
                    <p className='text-one-zero-nine  text-lg leading-6 md:text-center text-justify'>  Meet our chrome extension. It lets you add contacts to Kula just as easily as you would want it. One-click and your fresh prospect is ready for a personalized reach out.</p>
                </div>
            </div>
        </div>
    )
