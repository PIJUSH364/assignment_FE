...
const RecruitmentStack = () => {
    return (
        <div className='responsive-flex-box common-container pb-40 items-center gap-9 '>
            <div className='text-left  md:w-1/2 '>
                <h1 className='tittle-one'>Plays well with your </h1>
                <h1 className='tittle-one pb-8'>recruitment stack</h1>
